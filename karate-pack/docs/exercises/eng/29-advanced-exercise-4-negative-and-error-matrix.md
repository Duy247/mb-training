...
- startWhen proposal:
  - TrainingCondition.ExerciseCompleted("advanced-exercise-3")
...
- title: Knowledge Summary - Negative and Error Matrix
...
- TrainingExercise fields:
  ...
  - [ ] preconditionExerciseIds includes "advanced-exercise-3"
one
