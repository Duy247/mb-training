# intermediate-exercise-13 - Mock-First Execution Switch
...
| Mode | GUIDED |
| Phase | Phase B |
| Prerequisite Exercise IDs | intermediate-exercise-12 |
...
### Step step-intermediate-exercise-13-01-setup - Prepare exercise assets
...
### Step step-intermediate-exercise-13-02-implement - Implement core behavior
...
### Step step-intermediate-exercise-13-03-verify - Run and verify
...
### Step step-intermediate-exercise-13-04-harden - Harden for project continuity
...
- startWhen proposal:
  - TrainingCondition.ExerciseCompleted("intermediate-exercise-12")
...
- title: Knowledge Summary - Mock-First Execution Switch
...
- TrainingExercise fields:
  ...
  - [ ] preconditionExerciseIds includes "intermediate-exercise-12"
one
