# intermediate-exercise-10 - Assertion hợp đồng
...
| Tiêu đề | Assertion hợp đồng |
| Cấp độ | INTERMEDIATE |
| Loại | EXERCISE |
| Mode | GUIDED |
| Giai đoạn | Phase B |
| Bài phụ thuộc | intermediate-exercise-9 |
...
### Bước step-intermediate-exercise-10-01-setup - Chuẩn bị tài nguyên cho bài tập
- Hướng dẫn: Create contract-focused feature and data assets.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-10-02-implement - Triển khai hành vi cốt lõi
- Hướng dẫn: Implement nested and list-wide contract assertions.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-10-03-verify - Chạy và xác minh
- Hướng dẫn: Run and verify strictness without flakiness.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-10-04-harden - Hoàn thiện để duy trì dự án
- Hướng dẫn: Document reusable contract snippets.
- Nhiệm vụ người học:
...
- 	itle: Tổng kết kiến thức - Contract Assertions
