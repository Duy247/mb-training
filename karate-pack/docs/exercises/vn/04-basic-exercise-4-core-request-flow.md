# basic-exercise-4 - Luồng request cốt lõi
...
| Tiêu đề | Luồng request cốt lõi |
| Cấp độ | BASIC |
| Loại | EXERCISE |
| Mode | GUIDED |
| Giai đoạn | Phase A |
| Bài phụ thuộc | basic-exercise-3 |
...
### Bước step-basic-exercise-4-01-setup - Chuẩn bị tài nguyên cho bài tập
- Hướng dẫn: Create dedicated feature for first GET endpoint flow.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-4-02-implement - Triển khai hành vi cốt lõi
- Hướng dẫn: Implement request steps with url/path/method/status.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-4-03-verify - Chạy và xác minh
- Hướng dẫn: Run and verify endpoint interaction.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-4-04-harden - Hoàn thiện để duy trì dự án
- Hướng dẫn: Refine assertions for stability and readability.
- Nhiệm vụ người học:
...
- 	itle: Tổng kết kiến thức - Core Request Flow
