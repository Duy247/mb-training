# intermediate-exercise-2 - Feature setup dùng chung
...
| Tiêu đề | Feature setup dùng chung |
| Cấp độ | INTERMEDIATE |
| Loại | EXERCISE |
| Mode | GUIDED |
| Giai đoạn | Phase B |
| Bài phụ thuộc | intermediate-exercise-1 |
...
### Bước step-intermediate-exercise-2-01-setup - Chuẩn bị tài nguyên cho bài tập
- Hướng dẫn: Create common setup feature artifact.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-2-02-implement - Triển khai hành vi cốt lõi
- Hướng dẫn: Replace duplicated setup with feature call pattern.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-2-03-verify - Chạy và xác minh
- Hướng dẫn: Run suites to validate scope and behavior.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-2-04-harden - Hoàn thiện để duy trì dự án
- Hướng dẫn: Harden shared setup contract for later exercises.
- Nhiệm vụ người học:
...
- 	itle: Tổng kết kiến thức - Shared Setup Feature
