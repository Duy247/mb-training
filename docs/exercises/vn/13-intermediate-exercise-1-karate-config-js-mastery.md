# intermediate-exercise-1 - Làm chủ karate-config.js
...
| Tiêu đề | Làm chủ karate-config.js |
| Cấp độ | INTERMEDIATE |
| Loại | EXERCISE |
| Mode | GUIDED |
| Giai đoạn | Phase B |
| Bài phụ thuộc | basic-exercise-12 |
...
### Bước step-intermediate-exercise-1-01-setup - Chuẩn bị tài nguyên cho bài tập
- Hướng dẫn: Create central configuration file for environments.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-1-02-implement - Triển khai hành vi cốt lõi
- Hướng dẫn: Implement env-based routing and shared values.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-1-03-verify - Chạy và xác minh
- Hướng dẫn: Run with specific env to verify switching.
- Nhiệm vụ người học:
...
### Bước step-intermediate-exercise-1-04-harden - Hoàn thiện để duy trì dự án
- Hướng dẫn: Document config conventions for future exercises.
- Nhiệm vụ người học:
...
- 	itle: Tổng kết kiến thức - karate-config.js Mastery
