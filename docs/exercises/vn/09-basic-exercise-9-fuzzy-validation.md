# basic-exercise-9 - Kiểm thử fuzzy
...
| Tiêu đề | Kiểm thử fuzzy |
| Cấp độ | BASIC |
| Loại | EXERCISE |
| Mode | GUIDED |
| Giai đoạn | Phase A |
| Bài phụ thuộc | basic-exercise-8 |
...
### Bước step-basic-exercise-9-01-setup - Chuẩn bị tài nguyên cho bài tập
- Hướng dẫn: Create schema-like validation scenarios with fuzzy markers.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-9-02-implement - Triển khai hành vi cốt lõi
- Hướng dẫn: Implement type and shape assertions for dynamic payloads.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-9-03-verify - Chạy và xác minh
- Hướng dẫn: Run and validate robustness against changing values.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-9-04-harden - Hoàn thiện để duy trì dự án
- Hướng dẫn: Harden fuzzy rules to avoid over-permissive checks.
- Nhiệm vụ người học:
...
- 	itle: Tổng kết kiến thức - Fuzzy Validation
