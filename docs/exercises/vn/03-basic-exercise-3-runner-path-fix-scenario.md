# basic-exercise-3 - Sửa đường dẫn Runner (Scenario)
...
| Tiêu đề | Sửa đường dẫn Runner (Scenario) |
| Cấp độ | BASIC |
| Loại | EXERCISE |
| Mode | SCENARIO |
| Giai đoạn | Phase A |
| Bài phụ thuộc | basic-exercise-2 |
...
### Bước step-basic-exercise-3-01-setup - Chuẩn bị tài nguyên cho bài tập
- Hướng dẫn: Open scenario workspace and inspect failing runner setup.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-3-02-implement - Triển khai hành vi cốt lõi
- Hướng dẫn: Fix incorrect classpath in runner method.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-3-03-verify - Chạy và xác minh
- Hướng dẫn: Run targeted test to verify correction.
- Nhiệm vụ người học:
...
### Bước step-basic-exercise-3-04-harden - Hoàn thiện để duy trì dự án
- Hướng dẫn: Capture fix pattern for future runner troubleshooting.
- Nhiệm vụ người học:
...
- 	itle: Tổng kết kiến thức - Runner Path Fix (Scenario)
